var firebaseConfig = {
  ...
  var signageboardservice1 = db.collection("brandingprojectservice").doc("brandingproject");
  ...
  var totalServicesRef = db.collection("brandingprojectservice").doc("totalServices");
      ...
      for (totalchecking = 0; totalchecking < totalservices; totalchecking++) {
        ...
        signageboardservice1.get().then(function (doc) {
          if (doc.exists) {
            ...
            storageRef.child('Brandingproject/sb1.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb2.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb3.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb4.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb5.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb6.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb7.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb8.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb9.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Brandingproject/sb10.jpg').getDownloadURL().then(function (url) {
