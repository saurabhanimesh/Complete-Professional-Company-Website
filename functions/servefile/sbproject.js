var firebaseConfig = {
  ...
  var signageboardservice1 = db.collection("signageboardprojectservice").doc("signageboardproject");
  ...
  var totalServicesRef = db.collection("signageboardprojectservice").doc("totalServices");
      ...
      for (totalchecking = 0; totalchecking < totalservices; totalchecking++) {
        ...
        signageboardservice1.get().then(function (doc) {
          if (doc.exists) {
            ...
            storageRef.child('SignageBoardproject/sb1.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb2.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb3.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb4.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb5.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb6.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb7.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb8.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb9.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('SignageBoardproject/sb10.jpg').getDownloadURL().then(function (url) {
