var firebaseConfig = {
  ...
  var signageboardservice1 = db.collection("printingprojectservice").doc("printingproject");
  ...
  var totalServicesRef = db.collection("printingprojectservice").doc("totalServices");
      ...
      for (totalchecking = 0; totalchecking < totalservices; totalchecking++) {
        ...
        signageboardservice1.get().then(function (doc) {
          if (doc.exists) {
            ...
            storageRef.child('Printingproject/sb1.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb2.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb3.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb4.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb5.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb6.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb7.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb8.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb9.jpg').getDownloadURL().then(function (url) {
            ...
            storageRef.child('Printingproject/sb10.jpg').getDownloadURL().then(function (url) {
